# LandscapeClientManager — Implementation Kickoff

You are building **LandscapeClientManager** from a complete PRD (Product Requirements Document) that has been decomposed into focused, implementation-ready files. This prompt is your guide to turning that PRD into a working application.
...
4. Read `docs/planning/03_Security_Rules.md`
5. Read `docs/planning/04_Cloud_Functions.md`
6. Read `docs/planning/05_UI_Design_System.md`
7. Read `docs/planning/06_Layout_Navigation.md`
8. Read `docs/planning/07_Pipeline_View.md`
9. Read `docs/planning/08_Client_Card_Profile.md`
10. Read `docs/planning/09_Notes_Activity_Log.md`
11. Read `docs/planning/10_File_Management.md`
12. Read `docs/planning/11_Financials_Invoices.md`
13. Read `docs/planning/12_Milestones_Scheduling.md`
14. Read `docs/planning/13_Google_Calendar_Sync.md`
15. Read `docs/planning/14_Needs_Attention.md`
16. Read `docs/planning/15_Archive_Management.md`
17. Read `docs/planning/16_Settings_Page.md`
18. Read `docs/planning/17_Future_Features.md`
...
- `docs/planning/03_Security_Rules.md`
- `docs/planning/04_Cloud_Functions.md`

**Features (build in numbered order):**
- `docs/planning/05_UI_Design_System.md`
- `docs/planning/06_Layout_Navigation.md`
- `docs/planning/07_Pipeline_View.md`
- `docs/planning/08_Client_Card_Profile.md`
- `docs/planning/09_Notes_Activity_Log.md`
- `docs/planning/10_File_Management.md`
- `docs/planning/11_Financials_Invoices.md`
- `docs/planning/12_Milestones_Scheduling.md`
- `docs/planning/13_Google_Calendar_Sync.md`
- `docs/planning/14_Needs_Attention.md`
- `docs/planning/15_Archive_Management.md`
- `docs/planning/16_Settings_Page.md`

**Deferred (skip for now):**
- `docs/planning/17_Future_Features.md`
...
Begin by reading `docs/planning/00_README.md`. Once you've read all 18 PRD files, set up the project and start building.
