...
## Project
- **Name:** FieldFlow
- **Domain:** Landscape architecture / outdoor services CRM
...
**Typography:** Merriweather + Cabin
**Primary:** #37704D (deep moss green)
**Accent:** #C16A3A (warm terracotta)
**Background:** #F7F3EE (warm cream)
**Signature:** Topographic contour line SVG patterns
